...
Page({
  ...
  // 加载章节索引
  loadSections() {
    const sectionsData = require('../../packageBasic/data/sections.js')
    // 为每个章节添加唯一索引
  ...
  loadNextChunk() {
    ...
    // 直接require，不能使用动态路径
    if (chunk === 0) {
      questions = require('../../packageBasic/data/questions_0.js')
    } else if (chunk === 1) {
      questions = require('../../packageBasic/data/questions_1.js')
    } else if (chunk === 2) {
      questions = require('../../packageBasic/data/questions_2.js')
    } else if (chunk === 3) {
      questions = require('../../packageBasic/data/questions_3.js')
    } else if (chunk === 4) {
      questions = require('../../packageBasic/data/questions_4.js')
    } else if (chunk === 5) {
      questions = require('../../packageBasic/data/questions_5.js')
    } else if (chunk === 6) {
      questions = require('../../packageBasic/data/questions_6.js')
    } else {
